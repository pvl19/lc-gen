#!/bin/bash
# Baseline comparison — TRAIN.
# Builds the deterministic gaia_id split and trains the Gaussian MLP baseline.
# All parameters hardcoded below — edit this file to change a run.
# Outputs land in output/baseline_comparison/.
#
# Run baseline_comparison_eval.sh afterwards to score everything on eval-10%.
